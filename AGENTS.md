...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/TextPolish/context` | Codebase overview, check index freshness |
| `gitnexus://repo/TextPolish/clusters` | All functional areas |
| `gitnexus://repo/TextPolish/processes` | All execution flows |
| `gitnexus://repo/TextPolish/process/{name}` | Step-by-step execution trace |
